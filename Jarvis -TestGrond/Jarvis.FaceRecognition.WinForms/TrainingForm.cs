...
namespace Jarvis.FaceRecognition.WinForms
{
    public partial class TrainingForm : Form
    {
        ...
        public TrainingForm(CascadeClassifier haarFace)
        {
            InitializeComponent();
            haar = haarFace;
        ...
        {
            RecognizerForm.Instance.InitializeCapture();
        }
        ...
        private void AddFace(Image<Gray, Byte> face, string name)
        {
            ...
            if (!Directory.Exists(Recognizer.TrainedFacesPath))
            {
                Directory.CreateDirectory(Recognizer.TrainedFacesPath);
            }
            ...
            string facesDataPath = Recognizer.TrainedFacesPath + "faces.xml";
        ...
        private string RandomImageName(string name)
        {
            ...
            return Recognizer.TrainedFacesPath + "face_" + name + "_" + random.Next().ToString() + ".jpg";
        }
